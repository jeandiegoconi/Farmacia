...
CREATE DATABASE IF NOT EXISTS `ecoproducts` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci;
USE `ecoproducts`;
...
INSERT INTO `compra` (`id_usuario`, `id_compra`, `estado`, `tipo_pago`, `order_id`) VALUES
(1, 1296762568, 'approved', 'credit_card', 2147483647);
...
(9, ' Tapsin Plus Noche Paracetamol 650 mg Solución Oral 1 Sobre ', 'Rápido alivio de los síntomas de la gripe y el resfrío común, la gripe y la congestión, indicado incluso como antigripal en casos de intolerancia o alergia al ácido acetilsalicílico. ', 690, '20220717221123.jpg', 1, 1),
(10, 'Ketoprofeno', '', 1880, '20220717033302.jpg', 1, 1),
...
(33, 'Ibuprofeno 400 mg 20', 'La cantidad a despachar será revisada por el químico farmacéutico según tratamiento adecuado.\r\n\r\nPrecio por producto fraccionado: $39\r\n\r\nCada comprimido contiene 400 mg de Ibuprofeno.\r\n\r\nIndicaciones: Tratamiento sintomático de estados inflamatorio dolorosos leves a moderados y/o estados febriles. Tratamiento de dismenorrea. Alivio de los síntomas y signos de artritis reumatoidea y osteoartritis.\r\n\r\nPosología: Administración oral. Rango y frecuencia: el médico debe indicar la posología y el tiempo de tratamiento apropiado a su caso particular, no obstante la dosis usual recomendada es: 200 a 800 mg 3 a 4 veces al día. La dosis máxima diaria no debe pasar los 3200 mg. Consejo de cómo administrarlo: puede tomarlo en conjunto con alimentos, leche o antiácidos para evitar malestar estomacal. Uso prolongado: el uso prolongado de este medicamento puede causar problemas estomacales (úlceras), inflamación del hígado, problemas a los riñones y hemorragias. No se recomienda tomarlo, sin vigilancia médica, más de 7 días para el tratamiento del dolor o más de 3 días si lo ha estado tomando para el control de la fiebre.\r\n\r\nContraindicaciones: No se debe usar AINES con excepción de ácido acetilsalicílico en el período inmediato a una cirugía de by-pass coronario.', 773, '20220717220304.jpg', 1, 1),
(34, 'Mascarilla Desechable Plana 3 Unidades', ' Mascarilla Desechable Plana 3 Unidades\r\nBeneficios\r\n\r\n    Cubre boca y nariz\r\n    Filtra los principales gérmenes del ambiente\r\n    Ayuda a evitar contagios de virus y bacterias\r\n    Es útil en cuidado de enfermos, procedimientos clínicos y hospitalarios\r\n    Protege contra salpicaduras de sangre y saliva\r\n    Ajuste anatómico', 990, '20220717220400.jpg', 1, 1),
...
(36, 'Shampoo Manzana Fresh 400 mL', 'Micro burbujas. Hasta 100% libre de caspa', 4299, '20220717220525.jpg', 1, 1),
...
(39, 'Bion 3 Senior Vitaminas 30 Comprimidos Recubierto', 'Tomar máximo 1 comprimido recubierto al día con suficiente líquido. Contraindicaciones: El producto no debe ser usado en caso de hipersensibilidad conocida a algunos de los ingredientes. ', 15, '20220717220821.jpg', 1, 1),
(40, 'Elcal Flex Colageno Hidrolizado Polvo Suspension Oral 30 Sobres', 'Elcal Flex se presenta en forma de polvo para suspensión oral en sobre.', 19990, '20220717220925.jpg', 1, 1);
